...
ADMIN_CHAT_ID = int(os.getenv("ADMIN_CHAT_ID", "6939723877"))

# Channels to join
REQUIRED_CHANNELS = [
    {"name": "Join", "url": "https://t.me/Sketch_Temp", "chat_id": "@Sketch_Temp"},
]

# Developer info
DEVELOPER_USERNAME = "@Sketch_Developer_Pro"

# Welcome message
WELCOME_MESSAGE = "🎉 *Welcome to FANTOM DELUXE AI* 🎉\n\nYour advanced AI assistant is ready to help you\\!"
